...
Эта статья — практическое руководство по созданию собственных Go-экшенов для платформы GitVerse. Если вы хотите научиться писать действия на Go и переиспользовать их в своих CI/CD-пайплайнах — вы попали по адресу.
